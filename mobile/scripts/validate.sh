...
#   3. expo export           — bundle the iOS Hermes bytecode
#   4. jest                  — JS unit tests for the data layer
#
...
echo ""
echo "▶ Layer 1/4 — expo install --check (SDK alignment)"
echo "──────────────────────────────────────────────────"
npx expo install --check

echo ""
echo "▶ Layer 2/4 — expo-doctor (project-wide health)"
echo "──────────────────────────────────────────────────"
...
echo ""
echo "▶ Layer 3/4 — expo export (iOS Hermes bundle smoke test)"
echo "──────────────────────────────────────────────────"
...
echo ""
echo "▶ Layer 4/4 — jest (data-layer unit tests)"
echo "──────────────────────────────────────────────────"
npx jest --silent --colors

# Bundle artefact is only useful for inspection; clean it so it
# doesn't get committed by accident or confuse subsequent runs.
rm -rf dist 2>/dev/null || true

echo ""
echo "──────────────────────────────────────────────────"
echo "✓ All 4 validation layers passed."
