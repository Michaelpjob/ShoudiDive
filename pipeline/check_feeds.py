...
FEEDS: list[FeedSpec] = [
    ...
    FeedSpec(
        feed_id="chl_dineof_sci_9km",
        category="satellite",
        consumer="fetch.py blender source #5 (last-resort)",
        probe_url="https://coastwatch.noaa.gov/erddap/griddap/noaacwNPPN20S3ASCIDINEOFDaily.html",
        method="GET",
        critical=False,
        notes="DINEOF Science-Quality 9km. ~12 day publication lag.",
    ),
    FeedSpec(
        feed_id="kd490_dineof_9km",
        category="satellite",
        consumer="fetch.py → kd490_*.png; fetch_visibility uses Secchi=1.7/Kd_490",
        probe_url="https://coastwatch.noaa.gov/erddap/griddap/noaacwNPPN20S3AkdSCIDINEOFDaily.html",
        method="GET",
        critical=False,
        notes="Multi-sensor Kd_490. Direct viz proxy. Sole source — no fallback.",
    ),
    FeedSpec(
