# Validation watchdog — 2026-09-18T06:27Z
...
### ⚠️ 3. 4 non-critical external feed(s) are red

Red feeds: chl_dineof_nrt_4km, chl_dineof_sci_9km, kd490_dineof_9km, chl_climo_modis_pfeg. Fallbacks may keep the model running, but redundancy is degraded.
...
Freshness/completeness failures: kd490:layer_date_stale, swell5d:summary_day_sparse, sst:sst_source_query_failed.
...
|---|---|---|---|---|---|
| `bight_nearshore` | 4 | 10.42 | +6.69 | 0% | 0.97 |
| `central_nearshore` | 1 | 5.38 | -5.38 | 100% | — |
...
|---|---|---|
| `cencoos` | 1 | -5.38 ft |
| `dive-shop-diveviz` | 1 | -6.68 ft |
| `dive-shop-justgetwet` | 3 | +11.15 ft |
