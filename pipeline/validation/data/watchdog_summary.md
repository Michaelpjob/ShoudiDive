# Validation watchdog — 2026-09-25T18:19Z
...
### 🔴 2. 2 critical external feed(s) are red
...
Red feeds: chl_climo_modis_pfeg, cdfw_mpa. Fallbacks may keep the model running, but redundancy is degraded.
...
|---|---|---|---|---|---|
| `bight_nearshore` | 4 | 10.50 | +8.30 | 25% | 1.00 |

## Per-source bias (informational)

| Source | n | Mean residual (predicted − observed) |
|---|---|---|
| `dive-shop-diveviz` | 1 | -2.83 ft |
| `dive-shop-justgetwet` | 3 | +12.02 ft |
