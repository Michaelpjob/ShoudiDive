# Validation watchdog — 2026-08-04T07:02Z
...
Red feeds: chl_dineof_nrt_4km, chl_dineof_sci_2km, kd490_dineof_2km, usgs_nwis_stat. Fallbacks may keep the model running, but redundancy is degraded.
...
Freshness/completeness failures: kd490:layer_date_stale.
...
|---|---|---|---|---|---|
| `bight_nearshore` | 4 | 12.79 | +9.37 | 75% | -1.00 |
| `central_nearshore` | 1 | 0.45 | -0.45 | 100% | — |
...
|---|---|---|
| `cencoos` | 1 | -0.45 ft |
| `dive-shop-diveviz` | 1 | -5.73 ft |
| `dive-shop-justgetwet` | 3 | +14.40 ft |
