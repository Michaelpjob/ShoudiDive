...
DRIVER_COEFFS: Dict[str, DriverCoefficients] = {
    ...
    "transition_islands":   DriverCoefficients(upwell=0.08, swell=0.08, precip=0.04, river=0.04, sst=-0.03, seasonal=0.25, exposure=0.32, tide=0.02, substrate=0.05, cloud=-0.05),
    "transition_offshore":  DriverCoefficients(upwell=0.06, swell=0.02, precip=0.00, river=0.00, sst=-0.02, seasonal=0.20, exposure=0.06, tide=0.00, substrate=0.00, cloud=-0.03),
    ...
    "bight_islands":    DriverCoefficients(upwell=0.04, swell=0.06, precip=0.03, river=0.03, sst=-0.02, seasonal=0.18, exposure=0.28, tide=0.02, substrate=0.05, cloud=-0.03),
    "bight_offshore":   DriverCoefficients(upwell=0.03, swell=0.01, precip=0.00, river=0.00, sst=-0.01, seasonal=0.15, exposure=0.04, tide=0.00, substrate=0.00, cloud=-0.02),
}
...
SECCHI_COEFFS: Dict[str, SecchiCoefficients] = {
    ...
    "central_offshore":     SecchiCoefficients(a=8.5, b=0.32),
    "transition_nearshore": SecchiCoefficients(a=4.5, b=0.28),
    "transition_islands":   SecchiCoefficients(a=7.0, b=0.30),
    "transition_offshore":  SecchiCoefficients(a=8.5, b=0.32),
    "bight_nearshore":      SecchiCoefficients(a=5.0, b=0.28),
    "bight_islands":        SecchiCoefficients(a=7.5, b=0.30),
    "bight_offshore":       SecchiCoefficients(a=8.5, b=0.32),
}
