...
const REGION_SAVED_SPOTS = {
  ...
  baja: [
    ...
    { id: "salsipuedes",  name: "Salsipuedes",     lng: -116.787, lat: 31.974 },
    { id: "sacramento",   name: "Sacramento Reef", lng: -115.79, lat: 29.76 },
    { id: "quatro-casas", name: "Quatro Casas",    lng: -116.05, lat: 30.75 },
    { id: "santa-ros",    name: "Santa Rosalillita",lng: -114.27, lat: 28.65 },
    { id: "san-benito",   name: "Isla San Benito", lng: -115.575, lat: 28.306 },
    { id: "cedros",       name: "Isla Cedros",     lng: -115.19, lat: 28.11 },
    { id: "bahia-tort",   name: "Bahía Tortugas",  lng: -114.896, lat: 27.655 },
    { id: "abreojos",     name: "Punta Abreojos",  lng: -113.575, lat: 26.715 },
    ...
    { id: "cabo",         name: "Cabo San Lucas",  lng: -109.894, lat: 22.876 },
    { id: "gordo-banks",  name: "Gordo Banks",     lng: -109.456, lat: 23.057 },
    // Sea of Cortez — south
    ...
    { id: "isla-danzante",name: "Isla Danzante",   lng: -111.251, lat: 25.786 },
    { id: "loreto",       name: "Loreto",          lng: -111.274, lat: 26.119 },
    ...
    { id: "bahia-angel",  name: "Bahía Ángeles",   lng: -113.51, lat: 29.035 },
    // North Cortez
